<div class="onecolumn">
    <div class="content">
        ...
        <?php $form=$this->beginWidget('CActiveForm', array(
                ...
                <p class="note"><?php echo Yii::t('cn','Fields with * are required.');?></p><br><br>
                ...
                <p>
                        ...
                        <?php echo $form->dropDownList($model, 'tid', CHtml::listData(Taxonomy::model()->tpage()->findAll(), "id", "name"),array('prompt' => Yii::t('cn', 'Please Select'))); ?><br>
                ...
                <div class="row buttons">
                        <?php echo CHtml::submitButton($model->isNewRecord ? Yii::t('cn', 'Create') : Yii::t('cn', 'Save'),array('class'=>'submit')); ?><br>
                </div>
