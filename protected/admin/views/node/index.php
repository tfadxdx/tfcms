...
$this->menu=array(
	...
	array('label'=>'Create Node', 'url'=>array('admin.php/node/create')),
);
?>
                                ...
                                <tbody>
                                            <? foreach ($model as $key=>$item): ?>
                                                <tr <?php if(($key%2) == 0){echo 'class="grey"';}?> >
                                                    ...
                                                    <th style="width:25%"><a href="<?php echo Yii::app()->request->baseUrl; ?>/admin/update/<?php echo $item->id;?>"><?php echo $item->title;?></a></th>
